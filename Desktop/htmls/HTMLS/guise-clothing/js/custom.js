...
gsap.set(".ball", {xPercent: -10, yPercent: -10});
...
$('.image-to-show > div > img').click(function(){
    var src = $(this).attr('src');
    $('.prd-img-main > img').attr('src',src);
})